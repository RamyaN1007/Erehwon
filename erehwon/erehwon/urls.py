...
from profiles.views import CallForActionView, ProjectFormView, project_add, project_list, project_update, idea_list, call_list
...
urlpatterns = [
    ...
    url(r'^accounts/login/$', loginUser, name="login"),
